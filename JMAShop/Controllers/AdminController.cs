    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> AddUser(AddUserViewModel addUserViewModel)
        {
            ...
            var user = new ApplicationUser()
            {
                ...
                IsOwner = addUserViewModel.IsOwner
        ...
        public async Task<IActionResult> EditUser(EditUserViewModel editUserViewModel)
        {
            ...
            if (user != null)
            {
                ...
                user.IsOwner = editUserViewModel.IsOwner; 
        ...
        public async Task<IActionResult> ManageClaimsForUser(string userId)
        {
            ...
            var claimsManagementViewModel = new ClaimsManagementViewModel { UserId = user.Id, AllClaimsList = JMAItemShopClaimTypes.ClaimsList };
